...
export async function minecraftWriteableToSource(writeable: MinecraftWriteable<object, object>, options: SourceWriteOptions): Promise<void> {
    //@ts-ignore Access Protected Method Hidden From API
    const {endpoint, response} = await writeable.generate();
